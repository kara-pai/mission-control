...
|-------|------|-------------|
| `client_comms_log` | append-only | Every email/message sent/received |
| `financial_documents` | persistent | All quotations, invoices, payment records |
| `contracts_proposals` | versioned | All docs — drafts, revisions, approved finals |
| `pending_items` | live-updated | Open tracker — emails, invoices, contracts |
| `research_reports` | persistent | All completed research |
...
### Memory Rules for Kara

1. All memory stores updated in real-time as Kara operates
...
**Status:** ✅ MEMORY SYSTEM CONFIGURED  
